...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 27, 2023 at 09:43 PM
...
CREATE TABLE `menu_panels` (
  ...
  `submenu` tinyint(1) NOT NULL,
  `keycheck` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `namayesh` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT 0,
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
ALTER TABLE `submenu_panels`
  ADD CONSTRAINT `submenu_panels_menu_id_foreign` FOREIGN KEY (`menu_id`) REFERENCES `menus` (`id`) ON DELETE CASCADE,
