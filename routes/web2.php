...
//    Route::resource('panel'                               , [App\Http\Controllers\Site\PanelController::class]);
//    Route::resource('users'                               , [App\Http\Controllers\Site\UserController::class]);
...
Route::group(['perfix' => 'Site'] , function (){
//     Authentication Routes...
    Route::get('login'      , [App\Http\Controllers\Auth\LoginController::class] , 'showLoginuserForm')->name('loginuser');
