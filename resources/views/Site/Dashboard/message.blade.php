...
@section('main')
                    <div class="dashboard-heading mb-5">
                        <h3 class="fs-22 font-weight-semi-bold">پیام</h3>
                    </div>
                    <div class="dashboard-message-wrapper d-flex my-4">
                        <div class="message-sidebar">
                            <form action="#" class="p-4">
                                <div class="form-group mb-0">
                                    <input class="form-control form--control form--control-gray pl-3" type="text" placeholder="جستجو کردن..." />
                                ...
                                <div class="notification-body scrolled-box scrolled--box custom-scrollbar-styled">
                                    <a href="#" class="media media-card align-items-center message-active">
                                        ...
                                        <div class="media-body overflow-hidden">
                                            <h5 class="fs-14">جواد جوادی</h5>
                                            <p class="text-truncate lh-18 pt-1 text-gray fs-13">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است</p>
                                            <span class="fs-12 d-block lh-18 pt-1 text-gray">5 دقیقه پیش</span>
                                        </div>
                                    </a>
                                    <a href="#" class="media media-card align-items-center">
                                        <div class="avatar-sm flex-shrink-0 mr-2 position-relative">
                                            <img class="rounded-full img-fluid" src="images/small-avatar-1.jpg" alt="تصویر آواتار" />
                                            <span class="dot-status position-absolute bottom-0 left-0"></span>
                                        </div>
                                        <div class="media-body overflow-hidden">
                                            <h5 class="fs-14">جواد جوادی <span class="badge badge-success p-1 ml-2">2</span></h5>
                                            <p class="text-truncate lh-18 pt-1 text-gray fs-13">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است</p>
                                            <span class="fs-12 d-block lh-18 pt-1 text-gray">5 دقیقه پیش</span>
                                        </div>
                                    </a>
