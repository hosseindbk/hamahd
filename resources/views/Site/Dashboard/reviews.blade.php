...
@section('main')
                    <div class="dashboard-heading mb-5">
                        <h3 class="fs-22 font-weight-semi-bold">بررسی ها</h3>
                    </div>
                        ...
                        <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                            ...
                            <div class="media-body">
                                ...
                                <div class="d-flex flex-wrap align-items-center pb-1">
                                    ...
                                    <p class="fs-14 pl-1">توسط <a href="#" class="text-color mx-1 hover-underline">استاد محمدباقر حیدری کاشانی</a> 2 روز پیش</p>
                                </div>
                                <p class="pb-3">
                                ...
                                <div class="d-flex flex-wrap align-items-baseline justify-content-between pb-1">
                                    ...
                                    <div class="generic-action-wrap generic--action-wrap-3">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left" aria-labelledby="dropdownMenuLinkThree">
                                                <a class="dropdown-item" href="#">کپی </a>
                                                <a class="dropdown-item" href="#">برش </a>
                                                <a class="dropdown-item" href="#">ویرایش </a>
                                                <a class="dropdown-item" href="#">حذف</a>
