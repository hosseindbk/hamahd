            ...
            <div class="col-lg-8 mr-auto">
                <div class="breadcrumb-content">
                    <ul class="generic-list-item generic-list-item-arrow d-flex flex-wrap align-items-center">
                        ...
                        <li><a href="#">{{$videos->title}}</a></li>
                    </ul>
                    <div class="section-heading">
                        <h2 class="section__title">{{$videos->title}}</h2>
                        <p class="section__desc pt-2 lh-30">{{$videos->description}}</p>
                    </div>
...
{{--                        <h6 class="ribbon ribbon-lg mr-2 bg-3 text-white">دوره ممتاز</h6>--}}
                    ...
                    <p class="pt-2 pb-1">ایجاد شده توسط <a href="#" class="text-color hover-underline">استاد محمدباقر حیدری کاشانی</a></p>
                            ...
                            <div class="card-body">
                                <div class="preview-course-video">
                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#previewModal">
                                        <img src="{{asset($videos->cover)}}" data-src="{{asset($videos->cover)}}" alt="{{$videos->title}}" class="w-100 rounded lazy" />
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header border-bottom-gray">
                    <div class="pr-2">
                        <h5 class="modal-title fs-19 font-weight-semi-bold lh-24" id="previewModalTitle">{{$videos->title}}</h5>
                    </div>
                </div>
                <div class="modal-body">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <video controls preload="metadata" poster="{{asset($videos->cover)}}" id="player" style="width: 100%">
                                    <source src="{{asset($videos->file_link)}}" type="video/mp4" />
