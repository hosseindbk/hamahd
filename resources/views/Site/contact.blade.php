                    ...
                    <div class="col-lg-12">
                        <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
                            <div class="section-heading">
                                <h2 class="section__title text-white">با ما تماس بگیرید</h2>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-4 responsive-column-half">
                        <div class="info-box">
                            ...
                            <h3 class="info__title">آدرس ما</h3>
                            <p class="info__text">تهران خیابان اول کوچه دوم پلاک سوم</p>
                        </div>
                    ...
                    <div class="col-lg-4 responsive-column-half">
                        <div class="info-box">
                            ...
                            <p class="info__text">onfo@example.com</p>
                            <p class="info__text">info@example.com</p>
                        </div>
                    ...
                    <div class="col-lg-4 responsive-column-half">
                        <div class="info-box">
                            ...
                            <p class="info__text">02123456789</p>
                            <p class="info__text">02123456789</p>
                        </div>
                ...
                <div class="row align-items-center pt-30px">
                    <div class="col-lg-5">
                        <div class="contact-content pb-5">
                            <div class="section-heading">
                                <h2 class="section__title pb-3">ما از اینکه ازت خبر داشته باشیم خوشحال میشویم</h2>
                        ...
                        <div class="card card-item">
                            <div class="card-body">
                                <form method="post" action="http://techydevs.com/demos/themes/html/aduca-demo/aduca/php/contact.php" class="contact-form">
                                    ...
                                    <!-- end input-box -->
                                    <div class="btn-box">
                                        <button id="send-message-btn" class="btn theme-btn" type="submit">ارسال پیام</button>
                                    </div>
                                    <!-- end btn-box -->
                                </form>
                            </div>
