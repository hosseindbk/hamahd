        ...
        <div class="container-fluid">
            <div class="inner-body">
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">مدیریت صوت سایت</h2>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('admin/panel')}}">صفحه اصلی</a></li>
                            <li class="breadcrumb-item"><a href="{{url('admin/slides')}}">مدیریت صوت سایت</a></li>
                            <li class="breadcrumb-item active" aria-current="page">ایجاد صوت سایت</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card custom-card">
                            <div class="card-body" style="background-color: #0000000a;border-radius: 10px 10px 0px 0px;">
                                <div class="row">
                                    <div class="col"><a href="{{url()->current()}}" class="btn btn-link btn-xs">ورود اطلاعات صوت سایت</a></div>
                                </div>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('gallerymusicmanage.store')}}" method="POST" enctype="multipart/form-data" id="form">
                                    <div class="row row-sm">
                                        @csrf
                                        <div class="col-md-12">
                                            {{--                                            @include('error')--}}
        ...
        jQuery(document).ready(function(){
            jQuery('#submit').click(function(e){
                ...
                swal({
                    ...
                    jQuery.ajax({
                        url: "{{ route('gallerymusicmanage.store') }}",
                        method: 'POST',
                        data: formData,
