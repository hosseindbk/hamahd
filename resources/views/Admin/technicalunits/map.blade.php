@extends('Admin.admin')
@section('title')
    <title> موقعیت مکانی واحدهای خدمات فنی </title>
        ...
        <div class="container-fluid">
            <div class="inner-body">
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">موقعیت مکانی واحدهای خدمات فنی</h2>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('admin/panel')}}">صفحه اصلی</a></li>
                            <li class="breadcrumb-item"><a href="{{url('admin/technicalunits')}}">نمایش واحدهای خدمات فنی</a></li>
                            <li class="breadcrumb-item active" aria-current="page">موقعیت مکانی واحدهای خدمات فنی</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <div class="row row-sm">
                                    @foreach($technicals as $technical_unit)
                                        <div class="col-md-12">
                                            <h3 class="text-center"> {{$technical_unit->title}} </h3>
                                            <p> آدرس : {{$technical_unit->address}}</p>
                                        </div>
                                    @endforeach
                                </div>
                                <div class="row row-sm">
