@extends('Admin.admin')
@section('title')
    <title> مدیریت کتب و نوشتارها </title>
        ...
        <div class="container-fluid">
            <div class="inner-body">
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">مدیریت کتب و نوشتارها</h2>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('admin/panel')}}">صفحه اصلی</a></li>
                            <li class="breadcrumb-item active" aria-current="page">مدیریت کتب و نوشتارها</li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card custom-card overflow-hidden">
                            <div class="card-body" style="background-color: #0000000a;border-radius: 10px 10px 0px 0px;">
                                <div class="row">
                                    <div class="col"><a href="{{url()->current()}}" class="btn btn-link btn-xs">لیست کتب و نوشتارها سایت</a></div>
                                    <div class="col text-left"><a href="{{url('admin/bookmanage/create')}}" class="btn btn-primary btn-xs">+ افزودن کتب و نوشتارها سایت</a></div>
                                </div>
                            </div>
                            <div class="card-body">
