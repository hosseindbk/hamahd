                    ...
                    <div class="col-lg-12">
                        <div class="card custom-card overflow-hidden">
                            <div class="card-body" style="background-color: #0000000a;border-radius: 10px 10px 0px 0px;">
                                <div class="row">
                                    <div class="col"><a href="{{url()->current()}}" class="btn btn-link btn-xs">لیست برنامه ها سایت</a></div>
                                    <div class="col text-left"><a href="{{url('admin/programs/create')}}" class="btn btn-primary btn-xs">+ افزودن برنامه ها سایت</a></div>
                                </div>
                            </div>
                            <div class="card-body">
