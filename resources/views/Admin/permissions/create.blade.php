                ...
                <div class="page-header">
                    <div>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{url('admin/menudashboards')}}"> مدیریت دسترسی داشبورد</a></li>
                                    ...
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" data-required="1" placeholder="عنوان دسترسی داشبورد را وارد کنید" class="form-control" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <p class="mg-b-10">ادرس  دسترسی داشبورد</p>
                                                <input type="text" name="slug" data-required="1" placeholder="ادرس دسترسی داشبورد را وارد کنید" class="form-control" />
                                            </div>
                                        </div>
